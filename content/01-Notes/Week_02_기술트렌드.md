...
graph LR
    subgraph "BIM 진화 과정"
        A["3D BIM<br/>형상 모델링"] --> B["4D BIM<br/>+ 공정(시간)"]
        B --> C["5D BIM<br/>+ 비용"]
        C --> D["6D BIM<br/>+ 지속가능성"]
        D --> E["7D BIM<br/>+ FM(시설관리)"]
        E --> F["nD BIM<br/>+ AI/IoT/DT"]
    end
...
graph TB
    ...
    style T2 fill:#E74C3C,stroke:#333,color:#fff
    style T3 fill:#3498DB,stroke:#333,color:#fff
    style T4 fill:#9B59B6,stroke:#333,color:#fff
    style T6 fill:#27AE60,stroke:#333,color:#fff
```
...
flowchart LR
    ...
    Sensors --> Edge --> Cloud --> AI --> Dash

    style AI fill:#E74C3C,stroke:#333,color:#fff
    style Sensors fill:#3498DB,stroke:#333,color:#fff
```
...
flowchart TB
    ...
    subgraph Control["🎛️ HVAC 제어"]
        C1[설정온도 조정]
        C2[VAV 풍량]
        C3[냉동기 스케줄]
    end

    Sensors --> Pipeline --> ML --> Control

    style ML fill:#27AE60,stroke:#333,color:#fff
    style Control fill:#F39C12,stroke:#333,color:#fff
```
...
```mermaid
flowchart TB
    subgraph Input["📥 BIM 입력"]
        I1[IFC 파일]
        I2[Revit 모델]
    end

    subgraph Parser["🏗️ 파싱 엔진"]
        P1[ifcopenshell]
        P2[속성 추출]
        P3[기하 정보]
    end
    ...
    Input --> Parser --> AI --> Output

    style AI fill:#8E44AD,stroke:#333,color:#fff
    style Parser fill:#E67E22,stroke:#333,color:#fff
```
...
flowchart TB
    ...
    style DT fill:#9B59B6,stroke:#333,color:#fff
    style AI fill:#E74C3C,stroke:#333,color:#fff
```
...
> [!method] 이 섹션의 목적
> [[00-Syllabus/프로젝트주제_가이드|프로젝트 주제 가이드]]의 12개 주제 중 4개를 선정하여,
...
**평가 기준 연결** (→ [[00-Syllabus/평가전략_2026-1|평가전략]] 참고):
...
```mermaid
flowchart TD
    Q1{"팀에 CV/영상처리<br/>경험 있음?"}
    Q1 -->|"Yes"| Q2{"IoT/MQTT<br/>경험 있음?"}
    Q1 -->|"No"| Q3{"BIM/IFC<br/>경험 있음?"}

    Q2 -->|"Yes"| P7["#7 안전 모니터링<br/>★★☆"]
    Q2 -->|"No"| P2["#2 균열 감지<br/>★★☆"]

    Q3 -->|"Yes"| Q4{"Three.js 3D<br/>가능?"}
    Q3 -->|"No"| Q5{"NLP/RAG<br/>경험 있음?"}

    Q4 -->|"Yes"| P6["#6 디지털 트윈<br/>★★★"]
    Q4 -->|"No"| P4["#4 BIM 물량산출<br/>★★☆"]

    Q5 -->|"Yes"| P5["#5 법규 검토<br/>★★★"]
    Q5 -->|"No"| P8["#8 에너지 최적화<br/>★★☆"]

    style P2 fill:#27AE60,stroke:#333,color:#fff
    style P7 fill:#27AE60,stroke:#333,color:#fff
    style P5 fill:#E67E22,stroke:#333,color:#fff
    style P6 fill:#E67E22,stroke:#333,color:#fff
    style P4 fill:#3498DB,stroke:#333,color:#fff
    style P8 fill:#3498DB,stroke:#333,color:#fff
```

> [!ref] 전체 12개 프로젝트 상세
> → [[00-Syllabus/프로젝트주제_가이드|프로젝트 주제 가이드]] 참고
...
> - 팀 역할 분담
>
> → [[00-Syllabus/평가전략_2026-1|평가전략]] 루브릭 참고
